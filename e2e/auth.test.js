...
describe('Authentication E2E Tests', () => {
  ...
  describe('Registration Flow', () => {
    ...
    it('should show validation errors for empty required fields', async () => {
      ...
      await expect(element(by.text('Email is required'))).toBeVisible();
      await expect(element(by.text('Password is required'))).toBeVisible();
      await expect(element(by.text('Please confirm your password'))).toBeVisible();
    });
    ...
    it('should validate username length', async () => {
      ...
      await expect(element(by.text('Username must be at least 3 characters'))).toBeVisible();
    });
    ...
    it('should allow registration without organization field', async () => {
      ...
      await waitFor(element(by.text('Register'))).toBeVisible().withTimeout(5000);
    });
  ...
  describe('Deep Link Handling', () => {
    it('should handle password reset deep link', async () => {
      ...
      const resetUrl = 'wildlifewatcher://auth/reset-password?token_hash=test-token&type=recovery';
    ...
    it('should handle email confirmation deep link', async () => {
      ...
      const confirmUrl = 'wildlifewatcher://auth/callback?token_hash=test-token&type=signup';
