...
| File | What |
|---|---|
| [flow_bench.txt](flow_bench.txt) | Three-way log of the whole run, filtered: hex dumps, LED debug lines, nRF state-machine chatter, AE register blocks and motion-grid rows removed. The unfiltered capture is 16,208 lines and is kept on the bench PC. Trimmed again on 19 September 2026, from 9,109 lines to 3,096, before merging: plumbing dropped and repeated lines capped at the first three and the last of each kind, keeping every app line and every string these findings quote. The 9,109 line version is commit [a97c91ec](https://github.com/wildlifeai/ww-mobile-app/blob/a97c91ecd950488eccf1eff4cba02e034169e5ba/documentation/development%20reports/2026-09-04_person-detection-first-deployment/flow_bench.txt) |
| [fix268_bench.txt](fix268_bench.txt) | Same filter, the verification run of the #268 fix ([PR #270](https://github.com/wildlifeai/ww-mobile-app/pull/270)): dirtied ops, read-only connect, reset at Start, one poll per minute. Trimmed the same way, from 2,865 lines to 1,486. The longer version is commit [e3b989e9](https://github.com/wildlifeai/ww-mobile-app/blob/e3b989e9a937f44c5034ffde8d03d69276a80c84/documentation/development%20reports/2026-09-04_person-detection-first-deployment/fix268_bench.txt) |
