...
**Dev Deployment**: Engineer Console → Flows → "Dev Deployment Test". The project's capture method and capture flash, the camera, pictures per trigger, LED brightness and AI model, all chosen on screen. Detail: [Dev-Deployment-Guide.md](Dev-Deployment-Guide.md).
