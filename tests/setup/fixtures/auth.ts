...
export const mockDeepLinks = {
  passwordReset: 'wildlifewatcher://reset-password?token_hash=test-token&type=recovery',
  passwordResetInvalid: 'wildlifewatcher://reset-password?token_hash=&type=recovery',
  emailConfirmation: 'wildlifewatcher://auth/callback?token_hash=test-token&type=signup',
  emailConfirmationInvalid: 'wildlifewatcher://auth/callback?token_hash=&type=signup',
  generalCallback: 'wildlifewatcher://callback?token_hash=test-token&type=signup',
