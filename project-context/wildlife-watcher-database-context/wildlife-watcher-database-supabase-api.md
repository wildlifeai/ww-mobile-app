...
* Name: Dev_Wildlife_Watcher
* Project id: nuhwmubvygxyddkycmpa

* Connection string using Supabase Transaction Pooler  (IPv4): postgresql://postgres.nuhwmubvygxyddkycmpa:[YOUR-PASSWORD]@aws-0-ap-southeast-2.pooler.supabase.com:6543/postgres

* host: aws-0-ap-southeast-2.pooler.supabase.com
* port: 6543
* database: postgres
* user: postgres.nuhwmubvygxyddkycmpa
