		...
		ios: {
			...
			infoPlist: {
				...
				NSLocationAlwaysAndWhenInUseUsageDescription:
					"Wildlife Watcher needs access to your location to track deployments and provide navigation even when the app is in the background.",
				CFBundleURLTypes: [
					{
			...
			[
				"expo-location",
				{
					...
					locationWhenInUsePermission:
						"Wildlife Watcher needs access to your location to show your current position and camera deployment locations on the map.",
