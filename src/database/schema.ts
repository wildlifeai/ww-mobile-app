...
export default appSchema({
    ...
    tables: [
        ...
        tableSchema({
            ...
            columns: [
                { name: 'ai_model_id', type: 'string', isOptional: true, isIndexed: true },
                { name: 'bbox', type: 'string', isOptional: true },
                { name: 'category', type: 'string', isOptional: true },
                { name: 'confidence', type: 'number', isOptional: true },
                { name: 'is_blank_candidate', type: 'boolean' },
        ...
        tableSchema({
            ...
            columns: [
                ...
                { name: 'gbif_confidence', type: 'number', isOptional: true },
                { name: 'gbif_match_type', type: 'string', isOptional: true },
                { name: 'gbif_taxon_key', type: 'number', isOptional: true },
