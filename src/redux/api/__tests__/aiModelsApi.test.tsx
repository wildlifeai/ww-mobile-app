			...
			const mockModels: AIModel[] = [
				{
					...
					model_path: "models/general-wildlife-v1.tflite",
					labels_path: "models/general-wildlife-v1-labels.txt",
			...
			const mockModels: AIModel[] = [
				{
					...
					organisation_id: "org-123",
					modified_by: "user-123",
					model_path: "models/active-model.tflite",
					labels_path: "models/active-model-labels.txt",
					created_at: "2025-01-01T00:00:00Z",
					updated_at: "2025-01-01T00:00:00Z",
					deleted_at: null,
					description: "Active",
