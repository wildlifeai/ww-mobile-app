...
export const ProjectCard = React.memo(({ project, onPress }: ProjectCardProps) => {
  ...
  return (
    <Card
      ...
      accessible
      accessibilityLabel={`Project ${project.name}, ${project.member_count || 0} members, ${project.deployment_count || 0} deployments`}
    >
      <Card.Content style={styles.content}>
        ...
        <View style={styles.metadataRow}>
          ...
          <View style={styles.metadataItem} testID="deployment-count">
            ...
            />
            <Text variant="bodySmall" style={{ color: theme.colors.onSurfaceVariant }}>
              {project.deployment_count || 0} {(project.deployment_count || 0) === 1 ? 'deployment' : 'deployments'}
            </Text>
          </View>
        </View>
        ...
        {(project.lorawan_device_count || 0) > 0 && (
          <View style={styles.lorawanStatus} testID="lorawan-status">
            <View style={styles.metadataItem}>
              ...
              />
              <Text variant="bodySmall" style={{ color: theme.colors.onSurfaceVariant }}>
                {project.lorawan_device_count} LoRaWAN {(project.lorawan_device_count || 0) === 1 ? 'device' : 'devices'}
              </Text>
            </View>
        ...
        <Text
          variant="bodySmall"
          style={[styles.lastUpdated, { color: theme.colors.onSurfaceDisabled }]}
          testID="last-updated"
        >
