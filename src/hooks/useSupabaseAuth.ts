...
export const useSupabaseAuth = () => {
  ...
  const handleRegister = useCallback(async (credentials: RegisterRequest): Promise<AuthResponse> => {
    try {
  ...
  const handleUpdatePassword = useCallback(async (newPassword: string): Promise<void> => {
    try {
